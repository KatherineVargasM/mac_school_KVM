...
<head>
    ...
    <title>Nuevo Alumno - Laravel</title>
    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('alumnos.store') }}" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" name="txt_nombre" id="txt_nombre" maxlength="100" required value="{{ old('txt_nombre') }}">
                ...
                <div class="col-sm-9">
                    <select class="form-control" name="sel_curso" id="sel_curso" required>
                        ...
                        @foreach ($cursos as $curso)
                            <option value="{{ $curso->FCU_COD }}" {{ old('sel_curso') == $curso->FCU_COD ? 'selected' : '' }}>
                                {{ $curso->FCU_DESCRI }}
                            </option>
                        @endforeach
                    </select>
